            ...
            <div class="grid-container">
                ...
                <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                    ...
                    <span class="copyright">
                        <?php esc_html_e('Powered by' , 'unitedthemes'); ?> <a href="http://acmegh.com/" title="<?php esc_attr_e( 'A Semantic Personal Publishing Platform', 'unitedthemes' ); ?>" data-rel="generator"><?php printf( __( ' %s', 'unitedthemes' ), 'ACME GH' ); ?></a>
                    </span>
                </div>
            </div><!-- close container -->        
