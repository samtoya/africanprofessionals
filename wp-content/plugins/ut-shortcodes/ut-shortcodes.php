...
define('UT_SHORTCODES_VERSION', '4.2.3');
...
require_once( UT_SHORTCODES_DIR . '/shortcodes/big-icon.php' );
...
require_once( UT_SHORTCODES_DIR . '/shortcodes/fancy-link.php' );
...
require_once( UT_SHORTCODES_DIR . '/shortcodes/probar-2.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/quote-rotator.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/quote-rotator-2.php' );
...
//require_once( UT_SHORTCODES_DIR . '/shortcodes/letter-effects.php' );
...
if( defined( 'WPB_VC_VERSION' ) ) {
    ...
    require_once( UT_SHORTCODES_DIR . '/shortcodes/progress-circle.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/btn.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/icon-tabs.php' );
