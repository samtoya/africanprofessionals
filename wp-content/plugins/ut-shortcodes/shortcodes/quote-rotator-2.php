...
if( !class_exists( 'UT_Quote_Rotator_2' ) ) {
    ...
    class UT_Quote_Rotator_2 {
                ...
                vc_map(
                    array(
                        ...
                        'params'          => array(
                            ...
                            array(
								'type'              => 'attach_image',
                                'heading'           => esc_html__( 'Company Logo', 'ut_shortcodes' ),
        ...
        function ut_create_shortcode( $atts, $content = NULL ) {
            ...
            $output .= '<div class="ut-bkly-qt-rotator ut-bklyn-qt-rotator-style-2 ' . implode( ' ', $classes ) . '">';
                                ...
                                if( !empty( $imageicon ) ) {
                                    ...
                                    $output .= '<div class="bklyn-testimonials-icon-wrap">';
                                        ...
                                        $output .= '<div class="bklyn-testimonials-icon">';
                                            ...
                                            $output .= '<img alt="' . ( !empty( $author ) ? $author : 'icon' ) . '" src="' . esc_url( $imageicon ) . '">';
